...
namespace SummerCamp
{
    public partial class login : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            {
                Page.Title = "华东康桥 - 教职员系统";
                lblDEMO.Visible = false;
            }
            else
            {
                Page.Title = "华东康桥 - 教职员系统 (Demo Site)";
            ...
            else
            {
                try
                {
                    if (ADOp.checkAccount(Domain, Account, Password))
                    {
                        ...
                        ////寫入登錄紀錄
                        //sQueryString = "EXEC [LO_insert_summercamp] '" + Emp.ID + "',N'" + Emp.Name + "','" + Request.UserHostAddress + "'";
                        //DBName = "db_forminf";
                ...
                finally
                {
                    if (LoginSuccess)
                    {
                        ...
                        Response.Redirect("summercampuseradmin.aspx");
                    }
                }
            }
        }
