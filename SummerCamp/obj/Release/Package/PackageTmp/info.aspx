...
<body class="framework7-root">
                                ...
                                <div class="page-content">
                                    <div class="list-block">
                                        ...
                                        <ul>
                                            ...
                                            <li class="item-content" id="am">
                                                <div class="item-inner">
                                                    <div class="item-title">上午营队:</div>
                                                    <div class="item-after">
                                                        <%--<asp:TextBox ID="txt_gread" runat="server" Width="100%" BorderWidth="0px" Font-Size="14px" ForeColor="Gray"></asp:TextBox>--%>
                                                        <asp:DropDownList ID="SWYD" runat="server" Width="100%" Font-Size="14px" ForeColor="#666666">
                                                            <asp:ListItem Value="0">---请选择上午营队---</asp:ListItem>
                                                            <asp:ListItem Value="校内上午营队A-K3英语衔接营（K3）">校内上午营队A-K3英语衔接营（K3）</asp:ListItem>
                                                            <asp:ListItem Value="校内上午营队B-趣味英语营（G1-G6）">校内上午营队B-趣味英语营（G1-G6）</asp:ListItem>
                                                            <asp:ListItem Value="校内上午营队C-创梦科技营（G3-G6）">校内上午营队C-创梦科技营（G3-G6）</asp:ListItem>
                                                            <asp:ListItem Value="校内上午营队D-游泳加强营（K3-G6）">校内上午营队D-游泳加强营（K3-G6）</asp:ListItem>
                                                            <asp:ListItem Value="校内上午营队E-暑期托班（G1-G5）">校内上午营队E-暑期托班（G1-G5）</asp:ListItem>
                                                        </asp:DropDownList>
                                                    </div>
                                                </div>
                                            </li>
                                           <li class="item-content"  id="pm">
                                                <div class="item-inner">
                                                    <div class="item-title">下午营队:</div>
                                                    <div class="item-after">
                                                        <%--<asp:TextBox ID="txt_gread" runat="server" Width="100%" BorderWidth="0px" Font-Size="14px" ForeColor="Gray"></asp:TextBox>--%>
                                                        <asp:DropDownList ID="XWYD" runat="server" Width="100%" Font-Size="14px" ForeColor="#666666">
                                                            <asp:ListItem Value="0">---请选择下午营队---</asp:ListItem>
                                                            <asp:ListItem Value="校内下午营队F-快乐成长营（K3-G3）">校内下午营队F-快乐成长营（K3-G3）</asp:ListItem>
                                                            <asp:ListItem Value="校内下午营队G-篮球营（K3-G3）">校内下午营队G-篮球营（K3-G3）</asp:ListItem>
                                                            <asp:ListItem Value="校内下午营队H-羽毛球营（G3-G6）">校内下午营队H-羽毛球营（G3-G6）</asp:ListItem>
                                                            <asp:ListItem Value="校内下午营队I-篮球营（G4-G6）">校内下午营队I-篮球营（G4-G6）</asp:ListItem>
                                                            <asp:ListItem Value="校内下午营队J-暑期托班(G1-G5)">校内下午营队J-暑期托班(G1-G5)</asp:ListItem>
                                                        </asp:DropDownList>
                                                    </div>
                                                </div>
                                            </li>
                                    ...
                                    <div class="list-block">
                                        <ul>
                                            ...
                                            <li class="item-content" id="Iszhusu" runat="server">
                                                <div class="item-inner">
                                                    <div class="item-title">是否选择住宿<span style="font-size: 12px;">（一周费用420元）</span>:</div>
                                                    <div class="item-after" style="color: #920783;">
    ...
    <script>
        ...
        var spanContent = document.getElementById('lbl_course').textContent;
        console.log(spanContent);
        var am = document.getElementById('am');
        var pm = document.getElementById('pm');
        console.log(am)
        if (spanContent == "校内营队K3-G6") {
