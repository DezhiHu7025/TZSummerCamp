                                ...
                                <div class="tabs">
                                    <div id="tabclass2" class="tab tabclass2 active">
                                        <div class="list-block media-list course-card">
                                            ...
                                            <div class="choose">
                                                <button type="button" style="background: #ffd103; color: red; font-size:17px;border-radius:10px; margin:10px auto">1、	本次冬令营选课说明：分为上午及下午两部分营队报名，可以仅选择上午营队（含午餐），可以仅选下午营队（含晚餐），也可以选择上午营队（含午餐）+下午营队（含晚餐），还可以选住宿（含早餐）及不住宿，不吃餐食不退费。</button>
